 ...
 * sales@wijmo.com
 * wijmo.com/products-list/wijmo-5/license/
 *
 */
var wijmo;
!(function (e) {
    window.wijmo || (window.wijmo = e),
        (e.culture = window.wijmo.culture = {
            ...
            FlexGrid: {
                ...
                ariaLabels: { toggleDropDown: 'Desplegable de palanca', toggleGroup: 'Grupo de palanca' },
            },
            FlexGridDetailProvider: { ariaLabels: { toggleDetail: 'Cambiar fila detalle' } },
            FlexGridFilter: {
                ariaLabels: {
            ...
            InputDateTime: { ariaLabels: { tglDate: 'Cambiar calendario', tglTime: 'Lista de tiempo de cambiar' } },
            InputNumber: { ariaLabels: { incVal: 'Incrementa el valor', decVal: 'Disminuye el valor' } },
            MultiSelect: { itemsSelected: '{count:n0} ítems seleccionados', selectAll: 'Seleccionar todo' },
            olap: {
                PivotFieldEditor: {
